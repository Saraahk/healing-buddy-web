...
export default function DoctorApplyPage() {
  ...
  function validate() {
    ...
    if (!form.bio.trim())           e.bio           = 'Please write a brief introduction'
    return e
  }
  ...
  if (submitted) {
    return (
      <div className="apply apply--centered">
        <div className="apply__card apply__card--success">
          ...
          <button className="apply__btn" onClick={() => window.location.href = '/'}>
            Back to Home
          </button>
        </div>
      </div>
      ...
      <div className="apply__card">
        ...
        <form className="apply__form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="apply__row">
            ...
            <div className="apply__field">
              ...
              <div className={`apply__input-wrap ${errors.phone ? 'apply__input-wrap--error' : ''}`}>
                ...
                <input className="apply__input" type="tel" placeholder="+1 (555) 000-0000"
          ...
          <div className="apply__row">
            {/* CV Upload */}
            <div className="apply__field">
              <label className="apply__label">CV / Resume <span className="apply__optional">(optional)</span></label>
              <label className={`apply__upload ${form.cv ? 'apply__upload--selected' : ''}`}>
            ...
            {/* Medical Degree */}
            <div className="apply__field">
              <label className="apply__label">Medical Degree Certificate <span className="apply__optional">(optional)</span></label>
              <label className={`apply__upload ${form.degree ? 'apply__upload--selected' : ''}`}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <p className="apply__hint">
            ...
            <span className="apply__hint-em" style={{ cursor: 'pointer' }} onClick={() => window.location.href = '/signup'}>
              Sign in here.
            </span>
          </p>
