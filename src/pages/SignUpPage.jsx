...
export default function SignInPage() {
  ...
  function validate() {
    const e = {}
    if (!doctorId.trim()) e.doctorId = 'Doctor ID is required'
        ...
        <div className="signup__card">
          ...
          <form className="signup__form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="signup__field">
              <label className="signup__label">Doctor ID</label>
              <div className={`signup__input-wrap ${errors.doctorId ? 'signup__input-wrap--error' : ''}`}>
                ...
                <input
                  ...
                  value={doctorId}
                  onChange={e => { setDoctorId(e.target.value); setErrors(er => ({ ...er, doctorId: '' })) }}
                />
              </div>
              {errors.doctorId && <span className="signup__error">{errors.doctorId}</span>}
            </div>
